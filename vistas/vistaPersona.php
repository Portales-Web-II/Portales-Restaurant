...
<body id="body-pd">
  ...
  <div class="l-navbar" id="nav-bar">
    ...
    <div id="modal_personas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_personas"
        aria-hidden="true">
                ...
                <div class="modal-body py-0">
                    <div id="testmodal2" style="padding: 5px 20px;">
                        <form id="antoform2" class="form-horizontal calender" role="form">
                                ...
                                <div class="">
                                    <input type="text" class="form-control validatorword" id="nombre"
                                        name="nombre">
                                </div>
                            </div>					                            
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <input type="text" class="form-control validatorword" id="apellido"
                                        name="apellido">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="">
                                    <select id="idCargo" name="idCargo"
                                        class="select2_single form-control country">
                                        <option></option>
                                    <?php
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light antoclose2"
                                data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" id="btn_guardar_personas"
                                class="btn btn-primary antosubmit2">Guardar</button>
                        </div>
                    </div>
    ...
    <div id="modal_eliminar_personas" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal_eliminar_personas"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content rounded-6 shadow">
                <div class="modal-header border-bottom-0">
                ...
                <div class="modal-body py-0">
                    ...
                    <label class="control-label" style="font-size: 20px">¿Seguro que desea eliminar este registro?</label>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-light antoclose2"
                                data-bs-dismiss="modal">Cerrar</button>
                            <button type="button" id="btn_eliminar_personas"
                                class="btn btn-primary antosubmit2">Guardar</button>
                        </div>
                    </div>
...
function guardar_personas(){
	...
	if(response.msgError!=null){
        ...
        var nuevaFilaDT=[
        row.idPersona,row.nombre,row.apellido,row.telefono,row.nombreCargo,row.direccion,row.estado
