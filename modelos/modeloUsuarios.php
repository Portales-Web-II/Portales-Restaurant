<?php
    ...
    class Usuarios extends DB{
        ...
        public function getUsuario() {
            ...
            self::setNames();
            $sql = "SELECT idUsuario, nombreUsuario, correo, idPersona, estado FROM usuario";
        ...
        public function userExist($nombreUsuario, $password){
            ...
            $query = $this->connect()->prepare('SELECT * FROM usuario WHERE nombreUsuario = :nombreUsuario AND password = :password');
